        ...
        <div class="flex items-center space-x-5">
            ...
            <div>
                <div
                    ...
                    <i class="fas fa-pen-nib text-[8px]"></i>
                    <span>Configuration Update</span>
                </div>
                <h2 class="text-3xl font-bold text-primary tracking-tight">Perbarui Data Fasilitas</h2>
            </div>
        </div>

        <form action="{{ route('dermaga.update', $dermaga->id) }}" method="POST" class="space-y-8 pb-20">
            @csrf
            @method('PUT')
                        ...
                        <div class="p-8 space-y-6">
                            <div class="space-y-2">
                                ...
                                <input type="text" name="nama_dermaga" id="nama_dermaga" required class="form-input"
                                    placeholder="e.g. Dermaga Madura Utara - Sektor B"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="space-y-2">
                                    ...
                                    <input type="text" name="kode_dermaga" id="kode_dermaga" required
                                        class="form-input font-mono font-bold tracking-widest"
                        ...
                        <div class="p-8 grid grid-cols-2 md:grid-cols-4 gap-6">
                            ...
                            <div class="col-span-2 space-y-2">
                                ...
                                <input type="text" name="latitude" id="latitude" class="form-input font-mono"
                                    placeholder="-7.xxxx" value="{{ old('latitude', $dermaga->latitude) }}">
                            </div>
                            <div class="col-span-2 space-y-2">
                                <label for="longitude"
                                    class="text-[10px] font-bold uppercase tracking-widest text-muted-foreground/70">Geo -
                                ...
                                <input type="text" name="longitude" id="longitude" class="form-input font-mono"
                                    placeholder="112.xxxx" value="{{ old('longitude', $dermaga->longitude) }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="layout-card overflow-hidden">
                        ...
                        <div class="p-8">
                            <textarea name="catatan_operasional" rows="4" class="form-input min-h-[120px] resize-none"
                                placeholder="Enter special instructions or operational constraints...">{{ old('catatan_operasional', $dermaga->catatan_operasional) }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:col-span-4 space-y-8">
                    ...
                    <div class="layout-card p-8">
                        ...
                        <div class="grid grid-cols-1 gap-2">
                            @php $currentFasilitas = old('fasilitas', $dermaga->fasilitas ?? []); @endphp
                            @foreach ($fasilitasOptions as $fasilitas)
                                <label
                                    ...
                                    <input type="checkbox" name="fasilitas[]" value="{{ $fasilitas }}"
                                        ...
                                        {{ in_array($fasilitas, $currentFasilitas) ? 'checked' : '' }}>
                                    <span
                    ...
                    <div class="layout-card p-1 bg-primary shadow-2xl shadow-primary/40 border-none">
                        <div class="p-6 space-y-4">
                            <button type="submit"
                                ...
                                Commit Changes <i class="fas fa-sync-alt ml-3"></i>
                            </button>
                            <a href="{{ route('dermaga.index') }}"
                                class="block text-center text-[9px] font-bold text-white/40 uppercase tracking-[0.2em] hover:text-white transition-colors">Abort
                                & Return</a>
                        </div>
                    </div>
                </div>
